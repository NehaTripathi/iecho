...
public class ContactResultListViewAdapter extends BaseAdapter {
	public String title[];
	public String description[];
	public Activity context;
	public LayoutInflater inflater;

	public ContactResultListViewAdapter(Activity context, String[] title,String[] description) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.contact_custom_row, null);
			holder.imgViewDetail = (ImageView) convertView.findViewById(R.id.contact_imgViewLogo);
			holder.imgViewReject = (ImageView) convertView.findViewById(R.id.contact_imgViewReject);
			holder.imgViewAccept = (ImageView) convertView.findViewById(R.id.contact_imgViewAccept);
			holder.txtViewTitle = (TextView) convertView.findViewById(R.id.contact_txtViewTitle);
